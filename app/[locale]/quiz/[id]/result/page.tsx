              ...
              <CardContent className="pb-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
                    ...
                    <div className="text-sm text-slate-600 dark:text-slate-400">{t('common.thinkingStyle') || '思维方式'}</div>
                  </div>
                  <div className="text-center p-4 bg-pink-50 dark:bg-pink-900/20 rounded-xl">
                    <div className="text-2xl mb-1">💡</div>
                    <div className="text-sm text-slate-600 dark:text-slate-400">{t('common.creativePotential') || '创意潜能'}</div>
                  </div>
                  <div className="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-xl">
                    <div className="text-2xl mb-1">🤝</div>
                    <div className="text-sm text-slate-600 dark:text-slate-400">{t('common.socialSkills') || '社交能力'}</div>
                  </div>
                  <div className="text-center p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl">
                    <div className="text-2xl mb-1">⚡</div>
                    <div className="text-sm text-slate-600 dark:text-slate-400">{t('common.actionAbility') || '行动力'}</div>
                  </div>
                </div>
              </CardContent>
            </Card>
